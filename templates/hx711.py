...
class HX711(object):
    ...
    def read_average(self, times=10):
        """
        Take multiple readings and return the average value.
        """
        sum_val = 0
    ...
    def tare(self, times=15):
        """
        Tare (zero) the scale by averaging multiple readings with no weight.
        """
    ...
    def get_value(self):
        """
        Return the raw value minus the offset.
        """
        return self.read() - getattr(self, 'offset', 0)
